...
export function ApproveClassificationDialog({ open, reason, setReason, saving, onCancel, onConfirm }: any) {
  if (!open) return null;
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/60 p-4">
      <div className="w-full max-w-lg rounded-xl border border-slate-200 bg-white p-4 shadow-xl dark:border-cyan-300/10 dark:bg-[#071525]">
        <h2 className="text-base font-black">Approve Classification</h2>
        <p className="mt-1 text-xs text-slate-500">Approval updates review status and creates audit/history records.</p>

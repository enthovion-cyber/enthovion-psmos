...
export function PssrTrainingImpactChecklist({ latest }: { latest?: Record<string, any> | null }) {
  if (!latest) return <TrainingCard title="Impact Checklist"><TrainingEmptyState title="No impact decision" message="Run the backend PSSR training impact check to generate checklist status." /></TrainingCard>;
